...
$html='<style>';
	$html .= 'td.width12{width: 12%}';
	$html .= 'td.width28{width: 27%}';
	$html .= 'td.width8{width: 8%}';
	$html .= 'td.width16{width: 16%}';
    ...
    $html .= 'tr.linefooter td{background-color:#bce7fa;}';
...
$phone = $employeeinfo['phone_pro'] ? $employeeinfo['phone_pro'] : ($employeeinfo['phone_perso'] ? $employeeinfo['phone_perso'] : ($employeeinfo['phone_mobile'] ? $employeeinfo['phone_mobile'] : ''));
...
// matricule fiscal
if($mysoc->idprof2){
	$matriculefiscal = $mysoc->idprof2;
}


$html .= '<div>'; 
// -------------------------------- HEADER
	$html .= '<table border="1" cellpadding="5px" cellspacing="0" class="footertabledown" style="width:100%;">'; 

		$html .= '<tr>';
			$html .= '<td style="width:33%;">';
				$html .= '<b>'.$langs->trans('Societe').'</b>';
			$html .= '</td>';
			$html .= '<td rowspan="4" style="width:33%;" align="center">';
				$html .= '<b><h2>'.$langs->trans('paieBulletin_de_paie').' '.$langs->trans('Month'.sprintf("%02d", date('m'))).' '.date('Y').'</h2></b>';
			$html .= '</td>';
			$html .= '<td style="width:33%;" align="center"><b>'.$langs->trans('numcnss').'</b></td>';
		$html .= '</tr>';
		
		$html .= '<tr>';
			$html .= '<td rowspan="2" style="width:33%;">';
				$html .= $mysoc->name;
			$html .= '</td>';
			$html .= '<td style="width:33%;" align="center">'.$cnss.'</td>';
		$html .= '</tr>';
		
		$html .= '<tr>';
			$html .= '<td style="width:33%;" align="center">'.$langs->trans("matriculefiscal").'</td>';
		$html .= '</tr>';
		
		$html .= '<tr>';
			$html .= '<td style="width:33%;">';
				$html .= $mysoc->getFullAddress(1, ' - ');
			$html .= '</td>';
			$html .= '<td style="width:33%;" align="center">'.$matriculefiscal.'</td>';
		$html .= '</tr>';
	...
	$html .= '<table border="1" cellpadding="4" cellspacing="0" class="headertable" style="width:100%;">'; 
		$html .= '<tr>';
			$html .= '<td class="width12" style="" align="center"> '.$langs->trans('paieMatricule').' </td>'; 
			$html .= '<td class="width28" style="" align="center"> '.$langs->trans('paieFullname').'</td>'; 
			$html .= '<td class="width10" align="center">'.$langs->trans('Categorie').'</td>'; 
			$html .= '<td class="width10" align="center">'.$langs->trans('paieDateembauche').'</td>'; 
			$html .= '<td class="width8" style="" align="center">'.$langs->trans('etatcivil').'</td>';  
			$html .= '<td class="width8" style="" align="center">'.$langs->trans('NBENF')	.'</td>';  
			$html .= '<td class="width16" style="" align="center">'.$langs->trans('paiecin').'</td>'; 
		$html .= '</tr>';

		$html .= '<tr>';
			$html .= '<td align="center"><b>'.$employeeinfo['matricule'].'</b></td>';
			$html .= '<td align="center"><b>'.$employeeinfo['name'].'</b></td>'; 
			$html .= '<td align="center"><b>'.$employeeinfo['categorie'].'</b></td>'; 
		...
		$html .= '<tr>';
			...
			$html .= '<td style="" align="center" colspan="2"> '.$langs->trans('Function').'</td>'; 
			$html .= '<td style="" align="center" colspan="3">'.$langs->trans('PaimentMode').'</td>'; 
			$html .= '<td style="" align="center">'.$langs->trans('Situation').'</td>'; 
		...
		$html .= '<tr>';
			...
			$html .= '<td align="center" colspan="2"><b>'.$employeeinfo['job'].'</b></td>'; 
			$html .= '<td align="center" colspan="3"><b>'.$payedwith.'</b></td>'; 
...
// -------------------------------- BODY
	...
	$html .= '<thead>';
		$html .= '<tr>';
		$html .= '<th style="width:'.$width_rubrique.'%;" align="center" colspan="">'.$langs->trans('Label').'</th>'; 
		$html .= '<th style="width:'.$width_taux.'%;" align="center">%</th>'; 
		$html .= '<th style="width:'.$width_code.'%;" align="center" colspan="">'.$langs->trans('Nombre').'</th>'; 
	...
	$html .= '<tbody>';
		$html .= '<tr>';
			$html .= '<td style="width:'.$width_rubrique.'%;" align="'.$left.'" colspan="">'; 
				$html .= $langs->trans('paienbdaywork');
			$html .= '</td>';
			
			$html .= '<td style="width:'.$width_taux.'%;"></td>';
			$html .= '<td style="width:'.$width_code.'%;" align="center">'.$object->nbdaywork.'</td>';
		...
		$html .= '<tr>';
			$html .= '<td style="width:'.$width_rubrique.'%;" align="'.$left.'" colspan="">'; 
				$html .= $langs->trans('paienbdayabsence');
			$html .= '</td>';
			
			$html .= '<td style="width:'.$width_taux.'%;"></td>';
			$html .= '<td style="width:'.$width_code.'%;" align="center">'.$object->nbdayabsence.'</td>';
			$html .= '<td style="width:'.$width_base.'%;"></td>';
	    	...
	    	foreach ($arrrules as $key => $rule) {
		    	...
		    	if(!$brut_showed && $key0 == '2RETENUES') {
		    		$html .= '<tr class="engras1">';
						...
						$html .= '<td style="width:'.$width_gains.'%;" align="'.$right.'">';
						$html .= $paiedolibarr->number_format($totbrut, 3, '.',' ');
						$html .= '</td>';
						$html .= '<td style="width:'.$width_retenue.'%;" align="'.$right.'">'; 
						$html .= '</td>';
					$html .= '</tr>';
		    	...
		    	// ========================================================================================================================================================
		    	elseif(!$base_showed && $key0 == '0BASIQUE' && $key == "SALARY") {
		    		$html .= '<tr class="engras1">';
						$html .= '<td style="width:'.$width_rubrique.'%;" align="'.$left.'" colspan="">'; 
							$html .= $langs->trans('paieSalaire_de_base');
						$html .= '</td>';
						...
						$html .= $paiedolibarr->number_format($rule->amount, 3, '.',' ');
						$html .= '</td>';

						$html .= '<td style="width:'.$width_gains.'%;" align="'.$right.'">';
						// $sbase = $object->nbdaywork>0 ? ($rule->amount-($rule->amount*$object->nbdayabsence/$object->nbdaywork)) : $rule->amount;
						$html .= $paiedolibarr->number_format($rule->amount, 3, '.',' ');
						$html .= '</td>';
						$html .= '<td style="width:'.$width_retenue.'%;" align="'.$right.'">'; 
		    	...
		    	elseif(!$impo_showed && isset($afterretenus[$key0])) {
		    		...
		    		$html .= '<tr class="engras1">';
						...
						$html .= '<td style="width:'.$width_gains.'%;" align="'.$right.'">';
						$html .= $paiedolibarr->number_format($object->salairenet, 3, '.',' ');
						$html .= '</td>';
						$html .= '<td style="width:'.$width_retenue.'%;" align="'.$right.'">'; 
						$html .= '</td>';
					$html .= '</tr>';
	    		...
	    		if($key != 'SALARY'){
			    	...
			    	$html .= '<tr class="row'.$var.' '.$othcls.' engras'.(isset($rule->engras) ? $rule->engras : '').'">';
				        ...
				        $html .= '<td style="width:'.$width_taux.'%;" align="'.$right.'">'; 
					        if($rule->taux && $rule->taux > 0){
					        	...
					        	if($rule->taux == 100) {
					                ...
					                $html .= $paiedolibarr->number_format($rule->taux, 3, '.',' ');
						    }
				        $html .= '</td>';

				        // Code
				        $html .= '<td style="width:'.$width_code.'%;" align="right" colspan=""></td>'; 
				        ...
				        $html .= '<td style="width:'.$width_gains.'%;" align="'.$right.'">'; 
				        	if($apayer > 0)
					        	$html .= $paiedolibarr->number_format($apayer, 3, '.',' ');
				        $html .= '</td>';

				        // Retenues
				        $html .= '<td style="width:'.$width_retenue.'%;" align="'.$right.'">'; 
				        	if($adeduire > 0)
					        	$html .= $paiedolibarr->number_format($adeduire, 3, '.',' ');
	    ...
	    $html .= '<tr>';
			$html .= '<td style="width:'.$width_rubrique.'%;" align="'.$left.'" colspan="">'; 
				$html .= '<b>'.$langs->trans('paieSalaireNet').'</b>';
			$html .= '</td>';
			
			$html .= '<td style="width:'.$width_taux.'%;"></td>';
			$html .= '<td style="width:'.$width_code.'%;" align="center"></td>';
			$html .= '<td style="width:'.$width_base.'%;"></td>';

			$html .= '<td style="width:'.$width_retenue.'%;" align="'.$right.'"><b>'.$paiedolibarr->number_format($object->netapayer, 3, '.',' ').'</b></td>';
			$html .= '<td style="width:'.$width_gains.'%;" align="'.$right.'">';
			$html .= '</td>';
		$html .= '</tr>';
	...
	// 		$html .= '<td style="width:'.$width_code.'%;" align="center" rowspan="2" colspan="2">'.$langs->trans('Nombre').'</td>';
	...
	// 		// TOTAL GAINS (value)
	// 		$html .= '<td align="center">'.$paiedolibarr->number_format($totbrut, 3, '.',' ').'</td>';

	// 		// TOTAL RETENUES (value)
	// 		$html .= '<td align="center">'.$paiedolibarr->number_format($totretenus, 3, '.',' ').'</td>';
	...
	// 		$html .= '<td align="center">'.$paiedolibarr->number_format($object->salairenet, 3, '.',' ').'</td>';

	// 		// Cotisations sociales (value)
	// 		$html .= '<td align="center">'.$paiedolibarr->number_format($totretenus, 3, '.',' ').'</td>';

	// 		// Retenue IGR (value)
	// 		$html .= '<td align="center">'.$paiedolibarr->number_format($totaligr, 3, '.',' ').'</td>';
	...
	// 		// SALAIRE BRUT (value)
	// 		$html .= '<td align="center">'.$paiedolibarr->number_format($cumulsrules['brutcumul'], 3, '.',' ').'</td>';

	// 		// Salaire imposable (value)
	// 		$html .= '<td align="center">'.$paiedolibarr->number_format($cumulsrules['salairenetcumul'], 3, '.',' ').'</td>';

	// 		// Cotisations sociales (value)
	// 		$html .= '<td align="center">'.$paiedolibarr->number_format($totretenus, 3, '.',' ').'</td>';

	// 		// Retenue IGR (value)
	// 		$html .= '<td align="center">'.$paiedolibarr->number_format($cumulsrules['totaligrcumul'], 3, '.',' ').'</td>';
	...
	// 		// NET A PAYER (value)
	// 		$html .= '<td style="" align="center" class="engras1">'.$paiedolibarr->number_format($object->netapayer, 3, '.',' ').'</td>';
	...
	// 				// 	$html .= '</td>';
	// 				// 	$html .= '<td style="width:20%;" align="center">';
	// 				// 		$html .= $paiedolibarr->number_format($cumulsrules['brutmois'], 3, '.',' ');
	// 				// 	$html .= '</td>';
	// 				// 	$html .= '<td style="width:20%;" align="center">';
	// 				// 		$html .= $paiedolibarr->number_format($cumulsrules['salairenetmois'], 3, '.',' ');
	// 				// 	$html .= '</td>';
	// 				// 	$html .= '<td style="width:20%;" align="center">';
	// 				// 		$html .= $paiedolibarr->number_format($totalretenusmois, 3, '.',' ');
	// 				// 	$html .= '</td>';
	// 				// 	$html .= '<td style="width:20%;" align="center">';
	// 				// 	$html .= '</td>';
	// 				// $html .= '</tr>';
	...
	// 				// 	$html .= '</td>';
	// 				// 	$html .= '<td style="width:20%;" align="center">';
	// 				// 		$html .= $paiedolibarr->number_format($cumulsrules['brutcumul'], 3, '.',' ');
	// 				// 	$html .= '</td>';
	// 				// 	$html .= '<td style="width:20%;" align="center">';
	// 				// 		$html .= $paiedolibarr->number_format($cumulsrules['salairenetcumul'], 3, '.',' ');
	// 				// 	$html .= '</td>';
	// 				// 	$html .= '<td style="width:20%;" align="center">';
	// 				// 		$html .= $paiedolibarr->number_format($cumulsrules['retenuscumul'], 3, '.',' ');
	// 				// 	$html .= '</td>';
	// 				// 	$html .= '<td style="width:20%;" align="center">';
	// 				// 	$html .= '</td>';
	// 				// $html .= '</tr>';
	...
	// Table
	$html .= '<table border="1px" cellpadding="5" cellspacing="0" class="footertabledown" style="width:100%;">'; 
		$html .= '<tr class="linefooter">';
			$html .= '<td colspan="3"></td>';
		$html .= '</tr>';
		$html .= '<tr class="linefooter">';
			$html .= '<td align="center" style="width:33%;">'.$langs->trans('paieCachet_et_signature').'</td>'; 
			$html .= '<td align="center" style="width:33%;">'.$langs->trans('Emargement').'</td>'; 
			$html .= '<td align="center" style="width:34%;">'.$langs->trans('AmountNet').'</td>'; 
		$html .= '</tr>'; 
		$html .= '<tr>';
			$html .= '<td align="center" style="width:33%;"><br><br></td>'; 
			$html .= '<td align="center" style="width:33%;"><br><br></td>'; 
			$html .= '<td align="center" style="width:34%;"><br>'.$paiedolibarr->number_format($object->netapayer, 3, '.',' ').'<br></td>';
		$html .= '</tr>'; 
	$html .= '</table>'; 
