...
if ($action == 'update' && $request_method === 'POST') {
    ...
    $data['nbdayabsence'] = (int) GETPOST('nbdayabsence', 'int');
    ...
    print '<div class="fichehalfright">';
        print '<table class="border" width="100%">';
            ...
            print '<tr>';
                ...
                print '<td ><input type="number" size="8" class="" id="nbdayabsence" name="nbdayabsence" value="'.$item->nbdayabsence.'" autocomplete="off"/>';
                print '</td>';
            print '</tr>';
            ...
            $cts .= '<tr class="oddeven '.$clsclc.'" data-id="'.$i.'" title="">';
                ...
                $cts .= '<td class="td_action" align="center">';
                    if($rule->code != 'SALARY' && !$action_rule)
                        $cts .= '<a type="button" class="buttonrule remove" onclick="remove_tr_paie(this);"> <i class="fa fa-remove"></i> </a>';
                $cts .= '</td>';
