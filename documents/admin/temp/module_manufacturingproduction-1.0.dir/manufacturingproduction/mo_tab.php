 ...
 *  \brief      List if costcenter in mo
 */
...
$langs->loadLangs(array("manufacturingproduction@manufacturingproduction", "mrp", "companies"));
...
if ($id > 0 || !empty($ref)) {
    ...
    $journalstatic->printJournalLines($object, $object->id, $action, $permissiontoadd, $permissiontodelete);
